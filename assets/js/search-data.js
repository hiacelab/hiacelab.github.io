...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "research projects from the HiACE Lab",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
            ...
            },},{id: "news-publication-peihang-li-to-present-at-the-69th-hfes-international-annual-meeting",
          title: '[Publication] Peihang Li to Present at the 69th HFES International Annual Meeting',
          ...
          section: "Projects",handler: () => {
            ...
            },},{id: "projects-human-risk-perception-in-driving",
          title: 'Human Risk Perception in Driving',
          description: "Understanding and modeling how humans perceive risk in dynamic driving environments",
          section: "Projects",handler: () => {
              window.location.href = "/projects/riskperception/";
